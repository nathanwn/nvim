...
local mode_container = {
  ...
  static = {
    modes = {
      ...
      ["t"] = { name = "TERM", hlgroup = "HeirlineViModeOther" },
      ["nt"] = { name = "TERM", hlgroup = "HeirlineViModeOther" },
      ...
      ["r"] = { name = "PROMPT", hlgroup = "HeirlineViModeOther" },
      ["rm"] = { name = "MORE", hlgroup = "HeirlineViModeOther" },
      ["r?"] = { name = "CONFIRM", hlgroup = "HeirlineViModeOther" },
      ["!"] = { name = "SHELL", hlgroup = "HeirlineViModeOther" },
      ["null"] = { name = "null", hlgroup = "HeirlineViModeOther" },
    },
  },
